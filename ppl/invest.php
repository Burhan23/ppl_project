...
<body style="background-color:darkslategrey; background-size:cover;">
    <div class="container" >
        ...
        <form action="proses.php?&aksi=invest" enctype="multipart/form-data" method="post">
            ...
            <input type="submit" class="btn btn-primary" value="Simpan" onclick="return confirm('Permintaan akan dikirim ke pengrajin, Dana sudah siap?')">
            <a class="btn btn-primary" href="profile_Invest">Lihat Investor</a>
